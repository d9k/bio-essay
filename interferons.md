...
{% include image.html url="/images/interferon-bottled.jpg" width="400px" %}
...
Не следует регулярно принимать интерферон в больших количествах, т. к. это может привести к зуду и сыпи (особенно при местном нанесении на кожу или слизистую), к параличу глазных нервов (при закапывании в глаза), а также к увеличению симптомов депрессии. 

[^1]: Апоптоз (от греч. ἀπόπτωσις — опадание листьев) — программируемый процесс клеточной гибели, в результате которого клетка фрагментируется на отдельные апоптотические тельца, ограниченные плазматической мембраной)
